...
export default function Home({ navigation }) {
    ...
    return (
        <Center mt={50}>
            <Image alt="dfadf" source={{ uri: "https://res.cloudinary.com/dm8xxyjfx/image/upload/v1667532273/WaysTodo/accept-request_1_2x_xg6h9s.png" }} 
            ...
            <Pressable rounded={8} shadow={3} 
                mb={4} p={3} bg="#FF5555">
                <Text bold style={{ color: 'white', width: 325, textAlign: 'center' }} onPress={() => navigation.navigate("Login")}>Login</Text>
            </Pressable>
            <Pressable rounded={8} shadow={3} p={3} bg="coolGray.400">
                <Text bold style={{ color: 'white', width: 325, textAlign: 'center' }} 
